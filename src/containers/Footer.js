...
export default function Footer() {
    return(
		<Container className="footer text-center">
			<Row>
                <Col md={4} xs={12}>
                    <a className="nav-link text-muted" rel="noopener noreferrer" href="https://github.com/hanseongPark/phs-portfolio" target="_blank"><p><img className="img-circle-footer" src={git} alt="Generic placeholder image" width="30" height="30"/>Github</p></a>
                </Col>
                <Col md={4} xs={12}>
